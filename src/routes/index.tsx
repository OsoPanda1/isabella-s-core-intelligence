...
type ViewMode = "chat" | "images" | "memory" | "skills" | "monetization" | "projects" | "settings" | "premium" | "voice" | "pipeline" | "telemetry";
...
function Index() {
  ...
  return (
    <NavigationShell
      ...
      userName="Edwin"
    >
      {/* Toolbar ultra-minimal beneath topbar */}
      <div className="iso-toolbar">
        <div className="iso-toolbar-left">
          <span className="text-iris font-display text-xl tracking-tight">
            Isabella Villaseñor
          </span>
        ...
        <div className="iso-toolbar-right">
      ...
      <main className="iso-main">
        ...
        {(activeView === "pipeline" || activeView === "telemetry") && (
          <section className="flex min-w-0 flex-col gap-5">
